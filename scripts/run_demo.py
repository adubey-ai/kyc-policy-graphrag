...
from kyc_graphrag.eval import load_gold, recall_at_k, reciprocal_rank, score_case
...
def main() -> int:
    ...
    for case in gold:
        ...
        graph_recall += recall_at_k(graph_hits, case, k=8)
    ...
    print(
        ...
        f"graph_recall@8={graph_recall / len(gold):.3f}"
    )
    print(
        "latency   "
